...
@register_configs("rain_cityscapes")
class RainCityScapesConfig:

    # ==============================================================================
    # DIRECTORIES
    # ==============================================================================

    # CityScapes_rain Data Root
    DATA_DIR = '../data/CityScapes_rain/'
    TRAIN_IMG_DIR = '../data/CityScapes_rain/leftImg8bit_trainval_rain/leftImg8bit_rain/train'
    TRAIN_LABEL_DIR = '../data/CityScapes/gtFine/train'
    VAL_IMG_DIR = '../data/CityScapes_rain/leftImg8bit_trainval_rain/leftImg8bit_rain/val'
    VAL_LABEL_DIR = '../data/CityScapes/gtFine/val'
    
    IMG_SUFFIX = tuple(
        f"_leftImg8bit_rain_alpha_{a}_beta_{b}_dropsize_{d}_pattern_{i}.png"
        for a, b, d in [
            (0.01, 0.005, 0.01),
            (0.02, 0.01, 0.005),
            (0.03, 0.015, 0.002),
    ...
    # CityScapes_rain Visualization Results
    VAL_IMGS_DIR = ''
    VISUAL_IMGS_DIR = ''
