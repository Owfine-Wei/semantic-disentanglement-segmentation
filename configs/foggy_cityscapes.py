...
@register_configs("foggy_cityscapes")
class FoggyCityScapesConfig:

    # ==============================================================================
    # DIRECTORIES
    # ==============================================================================

    # CityScapes_foggy Data Root
    DATA_DIR = '../data/CityScapes_foggy/'
    TRAIN_IMG_DIR = '../data/CityScapes_foggy/leftImg8bit_trainvaltest_foggy/leftImg8bit_foggy/train'
    TRAIN_LABEL_DIR = '../data/CityScapes/gtFine/train'
    VAL_IMG_DIR = '../data/CityScapes_foggy/leftImg8bit_trainvaltest_foggy/leftImg8bit_foggy/val'
    VAL_LABEL_DIR = '../data/CityScapes/gtFine/val'
    
    IMG_SUFFIX = tuple(f'_leftImg8bit_foggy_beta_{a}.png' for a in [0.01, 0.02, 0.005])
    ...
    # CityScapes_foggy Visualization Results
    VAL_IMGS_DIR = ''
    VISUAL_IMGS_DIR = ''
